...
struct ResModelData : public ResTransformNodeData{
    nw::ut::ResS32 mMeshesTableCount;
    nw::ut::Offset toMeshesTable;
    nw::ut::ResS32 mMaterialsDicCount;
    nw::ut::Offset toMaterialsDic;
    nw::ut::ResS32 mShapesTableCount;
    nw::ut::Offset toShapesTable;
    nw::ut::ResS32 mMeshNodeVisibilitiesDicCount;
    nw::ut::Offset toMeshNodeVisibilitiesDic;
    nw::ut::ResBool mIsVisible;
    nw::ut::ResBool mIsNonuniformScalable;
    u8 _padding_0[6];
    nw::ut::ResU32 mLayerId;
};
