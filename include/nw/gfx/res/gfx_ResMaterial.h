...
struct ResMaterialColorData{
    nw::ut::ResFloatColor mEmission;
    nw::ut::ResFloatColor mAmbientAndVertexColorScale;
    nw::ut::ResFloatColor mDiffuse;
    nw::ut::ResFloatColor mSpecular0;
    nw::ut::ResFloatColor mSpecular1;
    nw::ut::ResFloatColor mConstant0;
    nw::ut::ResFloatColor mConstant1;
    nw::ut::ResFloatColor mConstant2;
    nw::ut::ResFloatColor mConstant3;
    nw::ut::ResFloatColor mConstant4;
    nw::ut::ResFloatColor mConstant5;
    nw::ut::ResU32 mEmissionU32;
    nw::ut::ResU32 mAmbientU32;
    nw::ut::ResU32 mDiffuseU32;
    nw::ut::ResU32 mSpecular0U32;
    nw::ut::ResU32 mSpecular1U32;
    nw::ut::ResU32 mConstant0U32;
    nw::ut::ResU32 mConstant1U32;
    nw::ut::ResU32 mConstant2U32;
    nw::ut::ResU32 mConstant3U32;
    nw::ut::ResU32 mConstant4U32;
    nw::ut::ResU32 mConstant5U32;
    void* mCommandCache;
};
...
struct ResRasterizationData{
    ...
    nw::ut::ResU32 mFlags;
    nw::ut::ResU32 mCullingMode;
    nw::ut::ResF32 mPolygonOffsetUnit;
    nw::ut::ResU32 mCommandBuffer[2];
};

struct ResBlendOperationData{
    nw::ut::ResS32        mMode;
    nw::ut::ResFloatColor mBlendColor;
...
struct ResFragmentOperationData{
    ResDepthOperationData   mDepthOperation;
    ResBlendOperationData   mBlendOperation;
    ResStencilOperationData mStencilOperation;
};

struct ResTextureCoordinatorData{
    nw::ut::ResS32  mSourceCoordinate;
    nw::ut::ResS32  mMappingMethod;
    nw::ut::ResS32  mReferenceCamera;
    nw::ut::ResS32  mMatrixMode;
    nw::ut::VEC2 mScale;
    nw::ut::ResF32  mRotate;
    nw::ut::VEC2 mTranslate;
    nw::ut::ResBool mIsDirty;
    nw::ut::ResBool mIsEnabled;
    u8              _padding_0[2];
    nw::ut::ResMtx34 mTextureMatrix;
};
...
struct ResMaterialData : public ResSceneObjectData{
    ...
    nw::ut::ResU32 mFlags;
    nw::ut::ResS32 mTextureCoordinateConfig;
    nw::ut::ResS32 mTranslucencyKind;
    ResMaterialColorData     mMaterialColor;
    ResRasterizationData     mRasterization;
    ResFragmentOperationData mFragmentOperation;
    nw::ut::ResS32 mActiveTextureCoordinatorsCount;
    ResTextureCoordinatorData mTextureCoordinators[3];
    nw::ut::Offset toTextureMappers[3];
    nw::ut::Offset toProceduralTextureMapper;
    nw::ut::Offset toShader;
    nw::ut::Offset toFragmentShader;
    nw::ut::ResS32 mShaderProgramDescriptionIndex;
    nw::ut::ResS32 mShaderParametersTableCount;
    nw::ut::Offset toShaderParametersTable;
    nw::ut::ResS32 mLightSetIndex;
    nw::ut::ResS32 mFogIndex;
    nw::ut::ResU32 mShadingParameterHash;
    nw::ut::ResU32 mShaderParametersHash;
    nw::ut::ResU32 mTextureCoordinatorsHash;
    nw::ut::ResU32 mTextureSamplersHash;
    nw::ut::ResU32 mTextureMappersHash;
    nw::ut::ResU32 mMaterialColorHash;
    nw::ut::ResU32 mRasterizationHash;
    nw::ut::ResU32 mFragmentLightingHash;
    nw::ut::ResU32 mFragmentLightingTableHash;
    nw::ut::ResU32 mFragmentLightingTableParametersHash;
    nw::ut::ResU32 mTextureCombinersHash;
    nw::ut::ResU32 mAlphaTestHash;
    nw::ut::ResU32 mFragmentOperationHash;
    nw::ut::ResU32 mMaterialId;
};
...
public:
    ...
    const nw::ut::FloatColor& GetAmbient() const { return ref().mAmbientAndVertexColorScale; }
    f32  GetVertexColorScale() const { return ref().mAmbientAndVertexColorScale.a; }
    void SetVertexColorScale(f32 scale) { ref().mAmbientAndVertexColorScale.a = scale; }
    u32  GetAmbientU32() const { return ref().mAmbientU32; }

    void SetAmbient(f32 r, f32 g, f32 b){
        ref().mAmbientAndVertexColorScale.SetColor(r, g, b);
        ref().mAmbientU32 = ref().mAmbientAndVertexColorScale.ToPicaU32();
    }
...
public:
    ...
    CullingMode GetCullingMode() const { return static_cast<CullingMode>(this->ref().mCullingMode); }
    void SetCullingMode(CullingMode value){
        ...
        this->ref().mCullingMode = static_cast<u32>(value);
        static const u32 table[] = { CMD_CULLING_MODE_OTHER, CMD_CULLING_MODE_BACK, CMD_CULLING_MODE_OTHER, CMD_CULLING_MODE_NONE };
        internal::SetCmdValue(&ref().mCommandBuffer[0], table[value], CMD_MASK, CMD_SHIFT);
    }
};
...
public:
    ...
    Mode GetMode() const { return static_cast<Mode>(ref().mMode); }
    ...
    void SetBlendColor(f32 r, f32 g, f32 b){
        ...
        ref().mBlendColor.Set(r, g, b);
        internal::SetCmdValue(&ref().mCommandBuffer[4], ref().mBlendColor.ToPicaU32(), CMD_MASK, CMD_SHIFT);
    }
    void SetBlendColor(f32 r, f32 g, f32 b, f32 a){
        enum { CMD_SHIFT = 0, CMD_MASK = 0xffffffff };
        ref().mBlendColor.Set(r, g, b, a);
        internal::SetCmdValue(&ref().mCommandBuffer[4], ref().mBlendColor.ToPicaU32(), CMD_MASK, CMD_SHIFT);
    }
    const nw::ut::FloatColor& GetBlendColor() const { return ref().mBlendColor; }
    void SetBlendColor(const nw::ut::FloatColor& value){
        enum { CMD_SHIFT = 0, CMD_MASK = 0xffffffff };
        ref().mBlendColor = value;
        internal::SetCmdValue(&ref().mCommandBuffer[4], ref().mBlendColor.ToPicaU32(), CMD_MASK, CMD_SHIFT);
    }

    LogicOp GetLogicOperation() const{
        enum { CMD_SHIFT = 0, CMD_MASK = 0xf };
        return static_cast<LogicOp>(internal::GetCmdValue(ref().mCommandBuffer[3], CMD_MASK, CMD_SHIFT));
    }
    void SetLogicOperation(LogicOp value){
        enum { CMD_SHIFT = 0, CMD_MASK = 0xf };
        internal::SetCmdValue(&ref().mCommandBuffer[3], value, CMD_MASK, CMD_SHIFT);
    }

    BlendFactor GetBlendFuncSrcRgb() const{
        enum { CMD_SHIFT = 16, CMD_MASK = 0xf };
        return static_cast<BlendFactor>(internal::GetCmdValue(ref().mCommandBuffer[2], CMD_MASK, CMD_SHIFT));
    }
    void SetBlendFuncSrcRgb(BlendFactor value){
        enum { CMD_SHIFT = 16, CMD_MASK = 0xf };
        internal::SetCmdValue(&ref().mCommandBuffer[2], value, CMD_MASK, CMD_SHIFT);
    }
    ...
    BlendEquation GetBlendEquationRgb() const{
        ...
        return static_cast<BlendEquation>(internal::GetCmdValue(ref().mCommandBuffer[2], CMD_MASK, CMD_SHIFT));
    }
...
public:
    ...
    u32 GetFlags() const { return static_cast<u32>(ref().mFlags); }
    ...
    TestFunc GetTestFunc() const{
        ...
        return static_cast<TestFunc>(internal::GetCmdValue(ref().mCommandBuffer[0], CMD_MASK, CMD_SHIFT));
    }
    void SetTestFunc(TestFunc value){
        ...
        internal::SetCmdValue(&ref().mCommandBuffer[2], table[value], CMD_MASK126, CMD_SHIFT126);
    }
...
public:
    ...
    s32 GetTestReference() const{
        ...
        return static_cast<s32>(internal::GetCmdValue(ref().mCommandBuffer[0], CMD_MASK, CMD_SHIFT));
    }
    ...
    u32 GetTestMask() const{
        ...
        return static_cast<u32>(internal::GetCmdValue(ref().mCommandBuffer[0], CMD_MASK, CMD_SHIFT));
    }
    ...
    StencilOp GetFailOperation() const{
        enum { CMD_SHIFT = 0, CMD_MASK = 0x7 };
        return static_cast<StencilOp>(internal::GetCmdValue(ref().mCommandBuffer[2], CMD_MASK, CMD_SHIFT));
    }
...
public:
    ...
    void SetFragmentOperationMode(FragmentOperationMode value){
        ...
        internal::SetCmdValue(&blendOperation.ref().mCommandBuffer[0], value, CMD_MASK, CMD_SHIFT);
    }
    FragmentOperationMode GetFragmentOperationMode() const{
        enum { CMD_SHIFT = 0, CMD_MASK = 0x3 };
        ResBlendOperation blendOperation = GetBlendOperation();
        NW_ASSERT(blendOperation.IsValid());
        return static_cast<FragmentOperationMode>(internal::GetCmdValue(blendOperation.ref().mCommandBuffer[0], CMD_MASK, CMD_SHIFT));
    }
...
public:
    ...
    const nw::math::VEC2& GetScale() const { return this->ref().mScale; }
    void SetScale(const nw::math::VEC2& scale){
        if (this->ref().mScale != scale){
            this->ref().mScale.Set(scale.x, scale.y);
            this->SetDirty(true);
        }
    }

    f32 GetRotate() { return this->ref().mRotate; }
    void SetRotate(f32 rotate){
        if (this->ref().mRotate != rotate){
            this->ref().mRotate = rotate;
            this->SetDirty(true);
        }
    }

    const nw::math::VEC2& GetTranslate() const { return this->ref().mTranslate; }
    void SetTranslate(const nw::math::VEC2& translate){
        if (this->ref().mTranslate != translate){
            this->ref().mTranslate.Set(translate.x, translate.y);
            this->SetDirty(true);
        }
    }
