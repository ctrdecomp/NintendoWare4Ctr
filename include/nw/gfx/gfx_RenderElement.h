...
public:
    ...
    virtual KeyType CreateRenderKey(const RenderElementType& renderElement, float depth, u8 layerId) = 0;

    virtual KeyType CreateCommandRenderKey(RenderCommand* command, ResMaterial::TranslucencyKind translucencyKind, u8 priority, u8 layerId) = 0;
...
public:
    ...
    virtual KeyType CreateCommandRenderKey(RenderCommand* command, ResMaterial::TranslucencyKind translucencyKind, u8 priority, u8 layerId)
    {
        ...
        renderKey.SetLayerId(layerId);
        renderKey.SetPriorityForSimpleMaterial(priority, RenderElementType::BIT64_DEPTH_BIT_SIZE);
...
public:
    ...
    virtual KeyType CreateRenderKey(const RenderElementType& renderElement, float depth, u8 layerId)
    {
        ...
        renderKey.SetDepth(
            depth,
            RenderElementType::BIT64_SIMPLE_MATERIAL_ID_BIT_SIZE + RenderElementType::BIT64_SIMPLE_MATERIAL_PRIORITY_BIT_SIZE);
