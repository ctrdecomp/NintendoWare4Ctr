...
public:
    ...
    static void EnablePrintVar(bool enble) { m_PrintVarEnabledFlag = enble; }
    static bool IsEnabledPrintVar() { return m_PrintVarEnabledFlag; }
protected:
...
private:
    static bool m_PrintVarEnabledFlag;
};
