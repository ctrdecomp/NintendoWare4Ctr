...
#ifndef NW_GFX_FRUSTUMPROJECTIONUPDATER_H_
#define NW_GFX_FRUSTUMPROJECTIONUPDATER_H_
...
public:
    ...
    //
    //---------------------------------------------------------------------------
    static FrustumProjectionUpdater* Create(os::IAllocator* allocator);
...
#endif // NW_GFX_FRUSTUMPROJECTIONUPDATER_H_
