...
#ifndef NW_GFX_ORTHOPROJECTIONUPDATER_H_
#define NW_GFX_ORTHOPROJECTIONUPDATER_H_
...
public:
    ...
    //
    //---------------------------------------------------------------------------
    static OrthoProjectionUpdater* Create(os::IAllocator* allocator);
...
#endif // NW_GFX_ORTHOPROJECTIONUPDATER_H_
