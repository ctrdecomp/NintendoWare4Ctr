...
#ifndef NW_GFX_SIMPLEMATERIALACTIVATOR_H_
#define NW_GFX_SIMPLEMATERIALACTIVATOR_H_
...
public:
    ...
    //
    //---------------------------------------------------------------------------
    static SimpleMaterialActivator* Create(os::IAllocator* allocator);
    ...
    //
    static void GetMemorySizeInternal(os::MemorySizeCalculator* pSize)
    {
...
private:
    ...
    NW_INLINE bool
    EqualHash(const TRes lhs, const URes rhs)
    {
        return (lhs.GetHash() == rhs.GetHash());
    }

    //
    SimpleMaterialActivator(os::IAllocator* allocator);
...
#endif // NW_GFX_SIMPLEMATERIALACTIVATOR_H_
