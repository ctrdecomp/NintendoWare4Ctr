...
#ifndef NW_GFX_TRANSFORMANIMINTERPOLATORLITE_H_
#define NW_GFX_TRANSFORMANIMINTERPOLATORLITE_H_
...
//
//---------------------------------------------------------------------------
class TransformAnimInterpolatorLite : public AnimInterpolator
{
public:
    ...
    public:
        ...
        void GetMemorySizeInternal(os::MemorySizeCalculator* pSize) const
        {
            ...
            size += sizeof(TransformAnimInterpolatorLite);
            TransformAnimInterpolatorLite::GetMemorySizeForInitialize(pSize, m_MaxAnimObjects);
        }
        ...
        //
        //
        TransformAnimInterpolatorLite* Create(os::IAllocator* allocator)
        {
            void* buf = allocator->Alloc(sizeof(TransformAnimInterpolatorLite));
            ...
            TransformAnimInterpolatorLite* interpolator = new(buf) TransformAnimInterpolatorLite(allocator);

            Result result = interpolator->Initialize(m_MaxAnimObjects, false);
...
protected:
    ...
    //
    //
    virtual ~TransformAnimInterpolatorLite() {}
