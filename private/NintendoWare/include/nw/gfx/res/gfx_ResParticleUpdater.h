...
#ifndef NW_GFX_RESPARTICLEUPDATER_H_
#define NW_GFX_RESPARTICLEUPDATER_H_
...
{
public:
    enum { TYPE_INFO = NW_GFX_RES_TYPE_INFO(ResParticleUpdater) };
    enum { SIGNATURE = NW_RES_SIGNATURE32('PUPD') };
...
{
public:
    enum { TYPE_INFO = NW_GFX_RES_TYPE_INFO(ResParticleAccelarationUpdater) };
    enum { SIGNATURE = NW_RES_SIGNATURE32('ACCE') };
    ...
    //
    //---------------------------------------------------------------------------
    NW_RES_FIELD_PRIMITIVE_DECL( f32, Factor ) // GetFactor(), SetFactor()
};
...
{
public:
    enum { TYPE_INFO = NW_GFX_RES_TYPE_INFO(ResParticleFloatUpdater) };
    enum { SIGNATURE = NW_RES_SIGNATURE32('FLOA') };
...
{
public:
    enum { TYPE_INFO = NW_GFX_RES_TYPE_INFO(ResParticleFloatImmediateUpdater) };
    enum { SIGNATURE = NW_RES_SIGNATURE32('FIMM') };
...
{
public:
    enum { TYPE_INFO = NW_GFX_RES_TYPE_INFO(ResParticleFloatImmediate4KeyUpdater) };
    enum { SIGNATURE = NW_RES_SIGNATURE32('FIM4') };
...
{
public:
    enum { TYPE_INFO = NW_GFX_RES_TYPE_INFO(ResParticleVector3Immediate4KeyUpdater) };
    enum { SIGNATURE = NW_RES_SIGNATURE32('V3I4') };
...
{
public:
    enum { TYPE_INFO = NW_GFX_RES_TYPE_INFO(ResParticleGeneralUpdater) };
    enum { SIGNATURE = NW_RES_SIGNATURE32('GENE') };
...
{
public:
    enum { TYPE_INFO = NW_GFX_RES_TYPE_INFO(ResParticleGravityUpdater) };
    enum { SIGNATURE = NW_RES_SIGNATURE32('GRAV') };
...
//--------------------------------------------------------------------------
//
struct ResParticleMagnetUpdaterData : public ResParticleUpdaterData
{
    nw::ut::ResF32 m_Power;         //
    nw::ut::ResVec3 m_Position;     //
...
//
//--------------------------------------------------------------------------
class ResParticleMagnetUpdater : public ResParticleUpdater
{
public:
    enum { TYPE_INFO = NW_GFX_RES_TYPE_INFO(ResParticleMagnetUpdater) };
    enum { SIGNATURE = NW_RES_SIGNATURE32('MGNT') };

    //
    enum ParticleMagnetFlags
    {
        MAGNET_X_ENABLED = 1 << 0, //
        MAGNET_Y_ENABLED = 1 << 1, //
        MAGNET_Z_ENABLED = 1 << 2  //
    };

    NW_RES_CTOR_INHERIT( ResParticleMagnetUpdater, ResParticleUpdater )
    ...
    //
    //---------------------------------------------------------------------------
    NW_RES_FIELD_VECTOR3_DECL( nw::math::VEC3, Position ) // GetPosition()
    ...
    //
    //---------------------------------------------------------------------------
    NW_RES_FIELD_PRIMITIVE_DECL( u32, Flags )
};
...
{
public:
    enum { TYPE_INFO = NW_GFX_RES_TYPE_INFO(ResParticleSpinUpdater) };
    enum { SIGNATURE = NW_RES_SIGNATURE32('SPIN') };
    ...
    //
    //---------------------------------------------------------------------------
    NW_RES_FIELD_VECTOR3_DECL( nw::math::VEC3, Axis ) // GetAxis()
};
...
{
public:
    enum { TYPE_INFO = NW_GFX_RES_TYPE_INFO(ResParticleRandomUpdater) };
    enum { SIGNATURE = NW_RES_SIGNATURE32('RNDU') };
    ...
    //
    //---------------------------------------------------------------------------
    NW_RES_FIELD_VECTOR3_DECL( nw::math::VEC3, Power ) // GetPower()
    ...
    //
    //---------------------------------------------------------------------------
    NW_RES_FIELD_PRIMITIVE_DECL( s32, Interval )             // GetInterval(), SetInterval()
};
...
{
public:
    enum { TYPE_INFO = NW_GFX_RES_TYPE_INFO(ResParticleVector2ImmediateUpdater) };
...
{
public:
    enum { TYPE_INFO = NW_GFX_RES_TYPE_INFO(ResParticleVector3Updater) };
    enum { SIGNATURE = NW_RES_SIGNATURE32('VEC3') };
...
{
public:
    enum { TYPE_INFO = NW_GFX_RES_TYPE_INFO(ResParticleVector3AdditiveUpdater) };
    enum { SIGNATURE = NW_RES_SIGNATURE32('V3AD') };
...
{
public:
    enum { TYPE_INFO = NW_GFX_RES_TYPE_INFO(ResParticleVector3ImmediateUpdater) };
...
{
public:
    enum { TYPE_INFO = NW_GFX_RES_TYPE_INFO(ResParticleVector3RandomAdditiveUpdater) };
    enum { SIGNATURE = NW_RES_SIGNATURE32('V3RA') };
...
{
public:
    enum { TYPE_INFO = NW_GFX_RES_TYPE_INFO(ResParticleRotateUpVectorUpdater) };
    enum { SIGNATURE = NW_RES_SIGNATURE32('RUVU') };
...
{
public:
    enum { TYPE_INFO = NW_GFX_RES_TYPE_INFO(ResParticleTexturePatternUpdater) };
    enum { SIGNATURE = NW_RES_SIGNATURE32('TPAT') };
...
{
public:
    enum { TYPE_INFO = NW_GFX_RES_TYPE_INFO(ResParticleChildUpdaterOption) };
    enum { SIGNATURE = NW_RES_SIGNATURE32('COPT') };
...
{
public:
    enum { TYPE_INFO = NW_GFX_RES_TYPE_INFO(ResParticleChildUpdaterFirstUpdateOption) };
    enum { SIGNATURE = NW_RES_SIGNATURE32('COBU') };
...
{
public:
    enum { TYPE_INFO = NW_GFX_RES_TYPE_INFO(ResParticleChildUpdaterFinalUpdateOption) };
    enum { SIGNATURE = NW_RES_SIGNATURE32('COFU') };
...
{
public:
    enum { TYPE_INFO = NW_GFX_RES_TYPE_INFO(ResParticleChildUpdaterIntervalOption) };
    enum { SIGNATURE = NW_RES_SIGNATURE32('COIN') };
...
{
public:
    enum { TYPE_INFO = NW_GFX_RES_TYPE_INFO(ResParticleChildUpdaterFrameOption) };
    enum { SIGNATURE = NW_RES_SIGNATURE32('COFN') };
...
public:
    ...
    enum { SIGNATURE = NW_RES_SIGNATURE32('CHLD') };
    ...
    //
    //---------------------------------------------------------------------------
    NW_RES_FIELD_CLASS_DECL( ResParticleChildUpdaterOption, Timing)    // GetTiming()
    ...
    //
    //---------------------------------------------------------------------------
    NW_RES_FIELD_PRIMITIVE_DECL( s32, EmissionRatio )            // GetEmissionRatio()
};
...
{
public:
    enum { TYPE_INFO = NW_GFX_RES_TYPE_INFO(ResParticleUserUpdater) };
    enum { SIGNATURE = NW_RES_SIGNATURE32('USER') };

    //
    typedef void (*UserFunctionType)(
        ParticleContext*,
        ParticleSet*,
        const ResParticleUserUpdater*,
        f32,
        f32
    );
    ...
    //
    //---------------------------------------------------------------------------
    NW_RES_FIELD_PRIMITIVE_DECL( u32, UserParameter )            // GetUserParameter()
};
...
//--------------------------------------------------------------------------
//
struct ResParticleCollisionUpdaterData : public ResParticleUpdaterData
{
	nw::ut::ResF32 m_Power;          //
	nw::ut::ResF32 m_Position;       //
    nw::ut::ResU32 m_Flags;          //
};
...
//
//--------------------------------------------------------------------------
class ResParticleCollisionUpdater : public ResParticleUpdater
{
public:
    enum { TYPE_INFO = NW_GFX_RES_TYPE_INFO(ResParticleCollisionUpdater) };
    enum { SIGNATURE = NW_RES_SIGNATURE32('COLL') };

    //
    enum ParticleCollisionFlags
    {
		COLLISION_IS_WORLD = 1, //

		COLLISION_REFLECTION = 0 << 1,   //
		COLLISION_CESSER = 1 << 1,       //
		COLLISION_REACTION_MASK = 1 << 1 //
    };

    NW_RES_CTOR_INHERIT( ResParticleCollisionUpdater, ResParticleUpdater )
    ...
    //
    //---------------------------------------------------------------------------
    NW_RES_FIELD_PRIMITIVE_DECL( f32, Position )          // GetPosition(), SetPosition()
...
#endif // NW_GFX_RESPARTICLEUPDATER_H_
