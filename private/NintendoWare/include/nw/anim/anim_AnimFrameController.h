...
#ifndef NW_ANIM_ANIMFRAMECONTROLLER_H_
#define NW_ANIM_ANIMFRAMECONTROLLER_H_
...
public:
    ...
    //
    f32 GetFrame() const { return m_AnimFrame.GetFrame(); }
    ...
    void SetFrame(f32 frame)
    {
        m_AnimFrame.SetFrame(m_PlayPolicy(m_StartFrame, m_EndFrame, frame, m_UserData));
    }
...
#endif /* NW_ANIM_ANIMFRAMECONTROLLER_H_ */
