...
#ifndef NW_ANIM_ANIMBLEND_H_
#define NW_ANIM_ANIMBLEND_H_
...
public:
    ...
    //
    //
    bool HasBlend() const { return m_HasBlend; }

    //
    //
    //
    //
    bool HasPostBlend() const { return m_HasPostBlend; }
...
protected:
    ...
    //
    //
    bool OverrideFloatVector(
        AnimResult* dst,
        const AnimResult* src,
        int compCount,
        bit32 allCompValidFlag
    ) const;
...
public:
    ...
    {
        *reinterpret_cast<bool*>(dst->GetValueBuffer()) =
            *reinterpret_cast<const bool*>(src->GetValueBuffer());
    ...
    virtual void Apply(void* target, const AnimResult* result) const
    {
        *reinterpret_cast<bool*>(target) =
            *reinterpret_cast<const bool*>(result->GetValueBuffer());
    }

    virtual void ConvertToAnimResult(AnimResult* result, const void* source) const
    {
        *reinterpret_cast<bool*>(result->GetValueBuffer()) =
            *reinterpret_cast<const bool*>(source);
...
public:
    ...
    //
    AnimBlendOpInt()
    : AnimBlendOp(false, false) {} // No blending (always overwrite)
    ...
    virtual bool Override(AnimResult* dst, const AnimResult* src) const
    {
        *reinterpret_cast<int*>(dst->GetValueBuffer()) =
            *reinterpret_cast<const int*>(src->GetValueBuffer());
        dst->SetFlags(VALID_SINGLE);
        return true;
    }
    ...
    virtual void Apply(void* target, const AnimResult* result) const
    {
        *reinterpret_cast<int*>(target) =
            *reinterpret_cast<const int*>(result->GetValueBuffer());
    }

    virtual void ConvertToAnimResult(AnimResult* result, const void* source) const
    {
        *reinterpret_cast<int*>(result->GetValueBuffer()) =
...
public:
    ...
    virtual bool Override(AnimResult* dst, const AnimResult* src) const
    {
        *reinterpret_cast<float*>(dst->GetValueBuffer()) =
            *reinterpret_cast<const float*>(src->GetValueBuffer());
        dst->SetFlags(VALID_SINGLE);
        return true;
    }
    ...
    virtual void Apply(void* target, const AnimResult* result) const
    {
        *reinterpret_cast<float*>(target) =
            *reinterpret_cast<const float*>(result->GetValueBuffer());
    }

    virtual void ConvertToAnimResult(AnimResult* result, const void* source) const
    {
        *reinterpret_cast<float*>(result->GetValueBuffer()) =
...
public:
    ...
    virtual bool Override(AnimResult* dst, const AnimResult* src) const
    {
        ut::Offset* dstOffset = reinterpret_cast<ut::Offset*>(dst->GetValueBuffer());
        const ut::Offset* srcOffset = reinterpret_cast<const ut::Offset*>(src->GetValueBuffer());

        dstOffset->set_ptr(srcOffset->to_ptr());
        dst->SetFlags(VALID_SINGLE);
        return true;
    }
    ...
    virtual void Apply(void* target, const AnimResult* result) const
    {
        ut::Offset* dstOffset = reinterpret_cast<ut::Offset*>(target);
        const ut::Offset* srcOffset = reinterpret_cast<const ut::Offset*>(result->GetValueBuffer());
    ...
    virtual void ConvertToAnimResult(AnimResult* result, const void* source) const
    {
        ut::Offset* dstOffset = reinterpret_cast<ut::Offset*>(result->GetValueBuffer());
        const ut::Offset* srcOffset = reinterpret_cast<const ut::Offset*>(source);
