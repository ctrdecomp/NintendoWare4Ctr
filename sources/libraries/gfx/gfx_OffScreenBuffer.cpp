// Filename: gfx_OffScreenBuffer.cpp
//
    ...
    m_Texture(resTexture)
{
    ...
    this->m_BackBufferObject.SetHeight(resTexture.GetHeight());
    this->m_BackBufferObject.SetWidth(resTexture.GetWidth());
    ...
    case ResImageTexture::TYPE_INFO:{
            ...
            this->m_BackBufferObject.SetColorAddress(address);
        }
        break;
