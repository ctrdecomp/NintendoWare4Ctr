...
HemiSphereLight* HemiSphereLight::DynamicBuilder::Create(nw::os::IAllocator* allocator){
    ...
    //HemiSphereLight* light = new(memory) HemiSphereLight(allocator,resource,this->mDescription);
...
ResHemiSphereLightData* HemiSphereLight::CreateResHemiSphereLight(os::IAllocator* allocator, const char* name){
    ...
    resHemiSphereLight->mHeader.revision = ResLight::BINARY_REVISION;
    resHemiSphereLight->mHeader.signature = ResLight::SIGNATURE;
    
    resHemiSphereLight->mUserDataDicCount = 0;
    ...
    resHemiSphereLight->mChildrenTableCount = 0;
    resHemiSphereLight->toChildrenTable.set_ptr(NULL);
    resHemiSphereLight->mAnimGroupsDicCount = 0;
    ...
    resHemiSphereLight->mTransform = math::Transform3(scale, rotate, translate);
    resHemiSphereLight->mWorldMatrix = math::MTX34::Identity();
...
Result HemiSphereLight::CreateOriginalValue(os::IAllocator* allocator){
    ...
    mOriginalValue = ResHemiSphereLight(originalValue);
