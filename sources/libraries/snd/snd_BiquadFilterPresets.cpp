// Filename: snd_BiquadFilterPresets.cpp
//
...
Each table looks like it has these rows
...
void BiquadFilterLpf::GetCoefficients(int type, f32 value, BiquadFilterCallback::Coefficients* coef) const
{
    (void)type;
...
void BiquadFilterHpf::GetCoefficients(int type, f32 value, BiquadFilterCallback::Coefficients* coef) const
{
    (void)type;
    int coefSize = COEFFICIENTS_TABLE_SIZE;
    int coefIndex = static_cast<int>(static_cast<f32>(coefSize - 1) * value);
...
void BiquadFilterBpf512::GetCoefficients(int type, f32 value, BiquadFilterCallback::Coefficients* coef) const
{
    (void)type;
...
void BiquadFilterBpf1024::GetCoefficients(int type, f32 value, BiquadFilterCallback::Coefficients* coef) const
{
    (void)type;
...
void BiquadFilterBpf2048::GetCoefficients(int type, f32 value, BiquadFilterCallback::Coefficients* coef) const
{
    (void)type;
